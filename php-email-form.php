  ...
  public function send() {
    ...
    if ($this->ajax) {
        ...
        if (!isset($_SERVER['HTTP_X_REQUESTED_WITH']) || strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) !== 'xmlhttprequest') {
            // Check if the 'HTTP_X_REQUESTED_WITH' header is not set or if its value is not 'xmlhttprequest'
            return $this->error_msg['ajax_error'];
            // Return an error message indicating that the request should be an Ajax POST
        }
    }
